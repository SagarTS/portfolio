...
import { sendContactEmail, createMailtoLink, type ContactFormData } from "@/lib/email-service"
...
export function ContactSection() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setSubmitStatus({
                type: 'error',
                message: 'An unexpected error occurred. Please try again or contact me directly at sagartshrestha@gmail.com'
            })
        } finally {
    ...
    return (
        <section id="contact" className="py-24 dark:bg-gradient-to-b dark:from-slate-900 dark:to-black light:bg-gradient-to-b light:from-gray-400 light:to-gray-500 relative overflow-hidden">
            {/* Background Elements */}
            ...
            <div className="max-w-6xl mx-auto px-6">
                ...
                <div ref={ref} className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    >
                        <GlassCard className="p-8">
                            <h3 className="text-2xl font-bold dark:text-white light:text-gray-800 mb-6">Send me a message</h3>

                            {isClient ? (
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                            <label htmlFor="name" className="block dark:text-white/80 light:text-gray-700 text-sm font-medium mb-2">
                                                Name
                                            </label>
                                            <input
                                                type="text"
                                        ...
                                        <div>
                                            <label htmlFor="email" className="block dark:text-white/80 light:text-gray-700 text-sm font-medium mb-2">
                                                Email
                                            </label>
                                            <input
                                                type="email"
                                    ...
                                    <div>
                                        <label htmlFor="subject" className="block dark:text-white/80 light:text-gray-700 text-sm font-medium mb-2">
                                            Subject
                                        </label>
                                        <input
                                            type="text"
                                    ...
                                    <div>
                                        <label htmlFor="message" className="block dark:text-white/80 light:text-gray-700 text-sm font-medium mb-2">
                                            Message
                                        </label>
                                        <textarea
                                            id="message"
                    ...
                    >
                        {/* Contact Information */}
                        <GlassCard className="p-8">
                            <h3 className="text-2xl font-bold dark:text-white light:text-gray-800 mb-6">Get in touch</h3>
                            <div className="space-y-6">
                                {contactInfo.map((info, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div>
                                                <p className="dark:text-white/60 light:text-gray-600 text-sm">{info.label}</p>
                                                <p className="dark:text-white light:text-gray-800 font-medium">{info.value}</p>
                                            </div>
                                        </motion.a>
                                    )
                                })}
                        ...
                        {/* Social Links */}
                        <GlassCard className="p-8">
                            <h3 className="text-2xl font-bold dark:text-white light:text-gray-800 mb-6">Follow me</h3>
                        ...
                        >
                            <GlassCard className="p-6 border-2 border-green-500/30">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="dark:text-white light:text-gray-800 font-semibold">Available for new projects</p>
                                        <p className="dark:text-white/60 light:text-gray-600 text-sm">Response time: Usually within 24 hours</p>
                                    </div>
                                </div>
                            </GlassCard>
                        </motion.div>
                ...
                >
                    <p className="text-white/60">
                        © 2024 Sagar Thapa Shrestha. Built with Next.js, React, and lots of ☕
                    </p>
                </motion.div>
            </div >
        </section >
