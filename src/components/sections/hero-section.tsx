    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
                ...
                >
                    <motion.h1
                        className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-bold dark:bg-gradient-to-r dark:from-white dark:via-blue-100 dark:to-purple-200 dark:bg-clip-text dark:text-transparent light:bg-gradient-to-r light:from-gray-800 light:via-blue-600 light:to-purple-600 light:bg-clip-text light:text-transparent mb-5"
                ...
                >
                    <GlassCard className="max-w-2xl mx-auto p-6 md:p-8">
                        <p className="text-lg md:text-xl dark:text-white/90 light:text-gray-800 leading-relaxed">
                            Front-end engineer specializing in React, Next.js & TypeScript — I optimize UX and page speed so users stick around.
                            ...
                            — I optimize UX and page speed so users stick around.
                        </p>
                    </GlassCard>
                </motion.div>
                ...
                >
                    {[
                        { icon: Github, href: "https://github.com/sagarts/", label: "GitHub" },
                        { icon: Linkedin, href: "https://www.linkedin.com/in/sagar-thapa-shrestha-30517b191/", label: "LinkedIn" },
                        { icon: Mail, href: "mailto:sagartshrestha@gmail.com", label: "Email" },
