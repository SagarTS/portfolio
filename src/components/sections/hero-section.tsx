...
const FloatingLogos = dynamic(() => import("@/components/ui/floating-logos"), {
    ssr: false,
});
...
export function HeroSection() {
    ...
    return (
        <section className='relative min-h-screen flex items-center justify-center overflow-hidden'>
            <div className='absolute inset-0 bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100 dark:from-gray-900 dark:via-gray-950 dark:to-black' />
                ...
                >
                    <GlassCard className='max-w-2xl mx-auto p-6 md:p-8'>
                        <p className='text-lg md:text-xl dark:text-white/90 light:text-gray-800 leading-relaxed'>
                            I&apos;m a front-end engineer who loves turning
                            ideas into smooth, responsive interfaces. My main
                            tools are{" "}
