...
const timelineData = [
    {
        ...
        company: "Freelance",
        description:
            "Began freelancing with small projects, starting from logo design and brand assets to building custom websites. This phase gave me hands-on experience with client communication, end-to-end project delivery, and combining both design and development to create real-world digital solutions.",
        icon: Code,
    ...
    },
    {
        ...
        description:
            "Started my journey building responsive websites with HTML, CSS, and vanilla JavaScript. Gained a strong foundation in web development and user experience design while transitioning into React and modern JavaScript. Delivered responsive, high-performing websites that improved usability and provided clients with scalable digital solutions.",
        icon: Rocket,
    ...
    },
    {
        ...
        description:
            "Joined as a Software Engineer focusing on architecting React and Next.js applications. Over the years, I grew into a Senior Frontend Engineer and Team Lead: mentoring developers, driving code quality standards, and leading projects from design to production.",
        icon: Users,
    ...
    },
    {
        ...
        company: "Upwork",
        description:
            "Delivering React.js and Next.js projects for international clients on Upwork. Focused on building high-performance, responsive applications and collaborating directly with clients to bring their ideas to life.",
        icon: Code,
...
export function AboutSection() {
    ...
    return (
        <section
            id='about'
            className='py-24 dark:bg-gradient-to-b dark:from-slate-900 dark:to-slate-800 light:bg-gradient-to-b light:from-gray-50 light:to-gray-100 relative overflow-hidden'
        >
            {/* Background Elements */}
            ...
            <div className='max-w-6xl mx-auto px-6'>
                ...
                >
                    ...
                    <p className='text-xl dark:text-white/70 light:text-gray-700 max-w-3xl mx-auto'>
                        From curious beginner to senior developer, here&apos;s
                        how I&apos;ve grown and evolved in the world of frontend
                        development.
                    </p>
                </motion.div>
                                    ...
                                    >
                                        <GlassCard className='p-8'>
                                            <div className='flex items-center gap-4 mb-4'>
                                                ...
                                                <div>
                                                    <div className='text-2xl font-bold dark:text-white light:text-gray-800'>
                                                        {item.year}
                                                    </div>
                                                    <div className='text-lg font-semibold dark:text-blue-200 light:text-blue-600'>
                                                        {item.title}
                                                    </div>
                                                    <div className='text-sm dark:text-white/60 light:text-gray-500'>
                                                        {item.company}
                                                    </div>
                                                </div>
                                            </div>
                ...
                >
                    {[
                        ...
                        >
                            ...
                            <div className='dark:text-white/60 light:text-gray-600 text-sm md:text-base'>
                                {stat.label}
                            </div>
                        </motion.div>
                    ))}
