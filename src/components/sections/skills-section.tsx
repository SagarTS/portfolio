...
const terminalCommands = [
    ...
    "git commit -m 'feat: add stunning features'",
...
export function SkillsSection() {
    ...
    return (
        <section
            id='skills'
            className='py-24 dark:bg-gradient-to-b dark:from-slate-800 dark:to-slate-900 light:bg-gradient-to-b light:from-gray-100 light:to-gray-200 relative overflow-hidden'
        >
            {/* Background Elements */}
            ...
            <div className='max-w-6xl mx-auto px-6'>
                ...
                >
                    ...
                    <p className='text-xl dark:text-white/70 light:text-gray-700 max-w-3xl mx-auto mb-8'>
                        ...
                        web applicationsThe technologies I rely on to craft
                        seamless user experiences and scalable apps.
                    </p>
                    ...
                    <motion.button
                        ...
                        className={`inline-flex items-center gap-2 px-6 py-3 rounded-full font-semibold transition-all duration-200 border-2 cursor-pointer relative z-10 ${
                            buttonClicked
                                ? "dark:bg-green-500/30 dark:text-green-300 dark:border-green-500/70 light:bg-green-600/30 light:text-green-700 light:border-green-600/70"
                                : isTerminalMode
                        ...
                        >
                            <GlassCard className='p-8 dark:bg-black/50 light:bg-gray-900/90 border-green-500/30'>
                                <div className='flex items-center gap-2 mb-6'>
                                    ...
                                    <span className='ml-4 dark:text-green-400 light:text-green-300 font-mono text-sm'>
                                        developer@portfolio:~$
                                    </span>
                                </div>

                                <div className='font-mono dark:text-green-400 light:text-green-300 space-y-2 min-h-[400px]'>
                                    <div className='dark:text-white/60 light:text-gray-200'>
                                        ...
                                        {terminalCommands.map(
                                            (command, index) => (
                                                ...
                                                >
                                                    ...
                                                    <span className='dark:text-white light:text-gray-100'>
                                                        {command}
                                                    </span>
                                                    <motion.span
                                                    ...
                                                    (skill, skillIndex) => (
                                                        ...
                                                        >
                                                            <div className='flex justify-between items-center mb-2'>
                                                                <span className='dark:text-white/90 light:text-gray-700 font-medium'>
                                                                    {skill.name}
                                                                </span>
                                                                <span className='dark:text-white/60 light:text-gray-500 text-sm'>
                                                                    {
                                                                        skill.level
                                                                    }
                                                                    %
