...
const projects = [
    {
        ...
        description: "Mobile jewelry marketplace app with product browsing, filtering, purchase tracking, and retailer chat.",
    ...
    },
    {
        ...
        description: "AI-powered CV builder and career support platform for students and professionals abroad.",
    ...
    },
    {
        id: 3,
        title: "Frail Check",
        description: "Comprehensive wellness and community platform with health tracking, event participation, and reward systems.",
        longDescription: "Admins manage frail checks and delegate tasks to business admins, offering tickets for healthy users or classroom bookings for improvement. The platform also supports transportation, invoicing, home visits, and QR-based event participation for earning redeemable points.",
    ...
    },
    {
        id: 4,
        title: "Kaki-Oki",
        description: "Innovative end-of-life platform helping individuals express final thoughts and preserve lasting memories.",
    ...
    },
    {
        id: 5,
        title: "Fanique",
        description: "NFT-based platform for buying and selling collectible basketball player cards.",
    ...
    },
    {
        id: 6,
        title: "BOTEJYU Group",
        description: "Restaurant loyalty platform with points, coupons, and rewards for customer engagement.",
...
export function ProjectsSection() {
    ...
    return (
        <section id="projects" className="py-24 dark:bg-gradient-to-b dark:from-slate-900 dark:to-black light:bg-gradient-to-b light:from-gray-200 light:to-gray-300 relative overflow-hidden">
            {/* Background Elements */}
            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                >
                    ...
                    <p className="text-xl dark:text-white/70 light:text-gray-700 max-w-3xl mx-auto">
                        A showcase of my most impactful work, featuring modern technologies and innovative solutions.
                    </p>
                </motion.div>
                ...
                <div ref={ref}>
                            ...
                            >
                                <GlassCard className="p-0 overflow-hidden h-full">
                                    <div className="relative group">
                                        ...
                                        {/* Project Info */}
                                        <div className="p-6">
                                            <h3 className="text-2xl font-bold dark:text-white light:text-gray-800 mb-3">{project.title}</h3>
                                            <p className="dark:text-white/70 light:text-gray-800 mb-4 leading-relaxed">{project.description}</p>
                    ...
                    <motion.div
                        ...
                        className="mb-8"
                    >
                        <h3 className="text-3xl font-bold dark:text-white light:text-gray-800 mb-8 text-center">More Projects</h3>
                            ...
                            {otherProjects.map((project, index) => (
                                ...
                                >
                                    <GlassCard className="p-6 h-full">
                                        ...
                                        <h4 className="text-xl font-bold dark:text-white light:text-gray-800 mb-2">{project.title}</h4>
                                        <p className="dark:text-white/70 light:text-gray-800 text-sm mb-4">{project.description}</p>
                    ...
                    >
                        <GlassCard className="p-8">
                            <div className="flex justify-between items-start mb-6">
                                <h3 className="text-3xl font-bold dark:text-white light:text-gray-800">{selectedProject.title}</h3>
                                <motion.button
                                    whileHover={{ scale: 1.1 }}
                                    whileTap={{ scale: 0.9 }}
                                    onClick={() => setSelectedProject(null)}
                            ...
                            <p className="dark:text-white/80 light:text-gray-800 leading-relaxed mb-6">{selectedProject.longDescription}</p>
