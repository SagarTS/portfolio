...
import { Building2, Calendar, MapPin, Download, FileText, Briefcase } from "lucide-react"
...
const experiences = [
    {
        ...
        endDate: "Present",
        type: "Full-time",
        description: "Driving frontend development from concept to delivery by building pixel-perfect web pages, integrating APIs, ensuring responsive design, and mentoring junior developers to create scalable and maintainable solutions.",
        achievements: [
        ...
        technologies: ["React", "Redux", "Typescript", "API Integration", "Responsive Design", "Code Review"],
        current: true,
    },
    {
        id: 2,
        ...
        endDate: "12/2021",
        type: "Full-time",
        description: "Built and optimized frontend applications using React, collaborating closely with designers and senior developers to deliver interactive, high-quality user interfaces.",
        achievements: [
        ...
        technologies: ["React", "HTML", "CSS", "JavaScript", "Redux", "State Management", "Component Lifecycle", "React Hooks"],
        current: false,
    },
];
...
export function ExperienceSection() {
    ...
    return (
        <section id="experience" className="py-24 dark:bg-gradient-to-b dark:from-black dark:to-slate-900 light:bg-gradient-to-b light:from-gray-300 light:to-gray-400 relative overflow-hidden">
            {/* Background Elements */}
            ...
            <div className="max-w-6xl mx-auto px-6">
                ...
                >
                    ...
                    <p className="text-xl dark:text-white/70 light:text-gray-700 max-w-3xl mx-auto mb-8">
                        My professional journey and achievements in the world of frontend development
                    </p>
                        ...
                        >
                            <GlassCard className="p-8 dark:bg-white/5 light:bg-white/60">
                                ...
                                <div className="text-center mb-8 pb-6 dark:border-b dark:border-white/20 light:border-b light:border-gray-300/50">
                                    <h3 className="text-3xl font-bold dark:text-white light:text-gray-800 mb-2">Sagar Thapa Shrestha</h3>
                                    <p className="dark:text-blue-200 light:text-blue-600 text-lg">Senior Frontend Developer</p>
                                    <p className="dark:text-white/60 light:text-gray-500">Bhaktapur, Nepal</p>
                                </div>
                                        ...
                                        {experiences.map((exp) => (
                                            <div key={exp.id} className="border-l-2 border-blue-500/30 pl-6">
                                                <div className="flex justify-between items-start mb-2">
                                                    <div>
                                                        <h5 className="text-xl font-bold dark:text-white light:text-gray-800">{exp.position}</h5>
                                                        <p className="dark:text-blue-200 light:text-blue-600 font-semibold">{exp.company}</p>
                                                    </div>
                                                ...
                                                <p className="dark:text-white/80 light:text-gray-800 mb-3">{exp.description}</p>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div>
                                        <h4 className="text-xl font-bold dark:text-white light:text-gray-800 mb-4">Education</h4>
                                        {education.map((edu, index) => (
                                            <div key={index} className="mb-4">
                                                <h5 className="text-lg font-semibold dark:text-blue-200 light:text-blue-600">{edu.degree}</h5>
                                                <p className="dark:text-white/80 light:text-gray-800">{edu.school}</p>
                                                <p className="dark:text-white/60 light:text-gray-500 text-sm">{edu.year}</p>
                                            </div>
                                        ))}
                                    </div>
                                    {/* <div>
                            ...
                            >
                                <GlassCard className="p-8 border-2 border-blue-500/30">
                                    <div className="flex items-center gap-4 mb-4">
                                        ...
                                        <div>
                                            <h3 className="text-2xl font-bold dark:text-white light:text-gray-800">Current Role</h3>
                                            <p className="dark:text-blue-200 light:text-blue-600">Software Engineer at readytowork-corp</p>
                                        </div>
                                    ...
                                    <p className="dark:text-white/80 light:text-gray-800 leading-relaxed">
                                        Leading projects from inception to completion, turning Figma designs into pixel-perfect web pages,
                                        implementing responsive design for all devices, and integrating APIs to enhance performance and usability.
                                        Mentoring junior developers and enforcing code review practices to ensure scalable, maintainable, and high-quality codebases.
                                    </p>
                                </GlassCard>
                            </motion.div>
                                        ...
                                        <GlassCard className="p-6 h-full">
                                            <div className="flex items-start justify-between mb-4">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <h4 className="text-xl font-bold dark:text-white light:text-gray-800">{exp.position}</h4>
                                                        <p className="dark:text-blue-200 light:text-blue-600 font-semibold">{exp.company}</p>
                                                    </div>
                                                </div>
                                                {exp.current && (
                                            ...
                                            <p className="dark:text-white/80 light:text-gray-800 text-sm mb-4 leading-relaxed">{exp.description}</p>

                                            <div className="mb-4">
                                                <h5 className="dark:text-white light:text-gray-800 font-semibold mb-2">Key Achievements:</h5>
