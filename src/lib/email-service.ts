...
export const sendContactEmail = async (formData: ContactFormData): Promise<{ success: boolean; message: string }> => {
    try {
        ...
        if (!isEmailConfigured()) {
            ...
            return {
                success: false,
                message: 'Email service not configured. Please contact me directly at sagartshrestha@gmail.com'
            }
        }
        ...
        const templateParams = {
            ...
            date: new Date().toLocaleDateString('en-US', { timeZone: 'Asia/Kathmandu' }),
        ...
        return {
            success: false,
            message: 'Failed to send message. Please try again or contact me directly at sagartshrestha@gmail.com'
        }
    }
}

// Fallback method using mailto link (for when EmailJS is not configured)
